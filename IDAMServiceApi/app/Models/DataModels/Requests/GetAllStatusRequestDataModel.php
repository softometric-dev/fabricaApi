...
class GetAllStatusRequestDataModel extends PaginationRequestDataModel
{
	...
	public static function fromJson($jsonString)
	{
		...
		$getAllStatusRequestDataModel = new GetAllStatusRequestDataModel();
		if ($jsonData != null) {
			$pagination = $jsonData->pagination ?? null;
			if ($pagination != null) {
				$paginationDataModel = PaginationDataModel::fromJson($pagination);
				$getAllStatusRequestDataModel->pagination = $paginationDataModel;
			}
		}
		return $getAllStatusRequestDataModel;
	}
}