...
class VerificationCodeException extends CustomException
{
    public function __construct($error, $additionalErrorDetails = '', Throwable $previous = null)
    {
        parent::__construct($error, $additionalErrorDetails, 400, $previous);
    }
    public static function exceptionHandler($severity, $message, $file, $line)
    {
       
        throw new VerificationCodeException($message, $severity);
    }
}
...
class InvalidUserException extends CustomException
{
    ...
    public static function exceptionHandler($severity, $message, $file, $line)
    {
        ...
        throw new InvalidUserException($message, $severity);
    }
}
